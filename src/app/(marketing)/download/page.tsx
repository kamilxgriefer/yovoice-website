  ...
  return (
    <>
      <PageHero
        ...
        description="The web app is live. YO Voice 1.0.0 build 18 is available to invited testers through Google Play Internal Testing and TestFlight; public store and desktop releases remain unavailable."
      />
